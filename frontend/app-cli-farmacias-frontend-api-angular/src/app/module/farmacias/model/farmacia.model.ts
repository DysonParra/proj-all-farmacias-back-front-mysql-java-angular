/*
 * @fileoverview    {FarmaciaViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code FarmaciaViewModel}.
 *
 * @author Dyson Parra
...
export class FarmaciaViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intCodigoFarmacia: number;
    public intIdBarrio: number;
    public strCelular: string;
    public strNit: string;
    public strNombre: string;
    public strTelefonoFijo: string;
    public strUrlExtraccion: string;

    /**
     * TODO: Description of method {@code newEntity}.
     *
     */
    public newEntity(): FarmaciaViewModel {
        return new FarmaciaViewModel();
    }
