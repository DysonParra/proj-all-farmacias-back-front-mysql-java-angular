/*
 * @fileoverview    {FarmaciaMedicamentoViewModel}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code FarmaciaMedicamentoViewModel}.
 *
 * @author Dyson Parra
...
export class FarmaciaMedicamentoViewModel extends GenericViewModel<number> {

    @Id
    @NotNull
    public intId: number;
    public intIdFarmacia: number;
     ...
     *
     */
    public newEntity(): FarmaciaMedicamentoViewModel {
        return new FarmaciaMedicamentoViewModel();
    }
