...
/**
 * TODO: Description of {@code AutenticacionViewModel}.
 *
 * @author Dyson Parra
...
export class AutenticacionViewModel extends GenericViewModel<number> {
     ...
     *
     */
    public newEntity(): AutenticacionViewModel {
        return new AutenticacionViewModel();
    }
