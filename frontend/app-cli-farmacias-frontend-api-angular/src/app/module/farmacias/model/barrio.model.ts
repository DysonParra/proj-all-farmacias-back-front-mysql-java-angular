...
/**
 * TODO: Description of {@code BarrioViewModel}.
 *
 * @author Dyson Parra
...
export class BarrioViewModel extends GenericViewModel<number> {
     ...
     *
     */
    public newEntity(): BarrioViewModel {
        return new BarrioViewModel();
    }
