/*
 * @overview        {TipoPersonaServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code TipoPersonaServiceImpl}.
 *
 * @author Dyson Parra
...
public class TipoPersonaServiceImpl implements GenericService<TipoPersonaDTO> {
    ...
    public Page<TipoPersonaDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo TipoPersona con paginación");
    ...
    public TipoPersonaDTO saveUpdate(TipoPersonaDTO entityDTO) throws Exception {
        ...
        TipoPersonaDTO dto = entityMapping.getDto(entity);
        return dto;
    }
