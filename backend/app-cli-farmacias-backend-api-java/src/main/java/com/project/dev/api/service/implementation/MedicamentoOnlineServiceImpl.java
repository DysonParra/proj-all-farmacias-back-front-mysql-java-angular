/*
 * @overview        {MedicamentoOnlineServiceImpl}
 *
 * @version         2.0
 *
...
import com.project.dev.api.repository.MedicamentoOnlineRepository;
import com.project.dev.api.service.GenericService;
import com.project.dev.api.service.exception.EntityNotFoundException;
import com.project.dev.api.service.mapping.MedicamentoOnlineMapping;
...
/**
 * TODO: Description of {@code MedicamentoOnlineServiceImpl}.
 *
 * @author Dyson Parra
...
public class MedicamentoOnlineServiceImpl implements GenericService<MedicamentoOnlineDTO> {

    private final Logger log = LoggerFactory.getLogger(MedicamentoOnlineServiceImpl.class);
    private final MedicamentoOnlineRepository entityRepository;
    private final MedicamentoOnlineMapping entityMapping = Mappers.getMapper(MedicamentoOnlineMapping.class);
     ...
     */
    public MedicamentoOnlineServiceImpl(MedicamentoOnlineRepository entityRepository) {
    ...
    public Page<MedicamentoOnlineDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo MedicamentoOnline con paginación");
     ...
     */
    @Override
    public MedicamentoOnlineDTO saveUpdate(MedicamentoOnlineDTO entityDTO) throws Exception {
        log.debug("Solicitud para guardar la entidad tipo MedicamentoOnline: {}", entityDTO);

        //TODO: agregar validación específica del servicio.
        MedicamentoOnline entity = entityMapping.getEntity(entityDTO);
        entity = entityRepository.save(entity);

        MedicamentoOnlineDTO dto = entityMapping.getDto(entity);
        return dto;
    }
     ...
     */
    @Override
    public MedicamentoOnlineDTO getEntity(String id) throws Exception {
    ...
    public void deleteEntity(String id) throws Exception {
        log.debug("Solicitud para eliminar la entidad tipo MedicamentoOnline: {}", id);
