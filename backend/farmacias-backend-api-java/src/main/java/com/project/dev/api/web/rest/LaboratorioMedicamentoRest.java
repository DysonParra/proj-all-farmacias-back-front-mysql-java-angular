...
public class LaboratorioMedicamentoRest {
    ...
    @GetMapping("/LaboratorioMedicamento/{query}/pages")
    public ResponseEntity<List<LaboratorioMedicamentoDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/LaboratorioMedicamento/{query}/pages/" + query);
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
