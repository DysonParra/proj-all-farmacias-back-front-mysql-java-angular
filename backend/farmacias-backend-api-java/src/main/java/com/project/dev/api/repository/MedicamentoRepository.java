/*
 * @fileoverview    {MedicamentoRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code MedicamentoRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface MedicamentoRepository extends JpaRepository<Medicamento, Long> {
     ...
     */
    public List<Medicamento> findByIntId(Long id);
    ...
    @Query("SELECT m FROM Medicamento m WHERE m.intId LIKE CONCAT('%', :strSearch, '%')")
    public List<Medicamento> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Medicamento m WHERE m.intId LIKE CONCAT('%', :strSearch, '%')")
    public Page<Medicamento> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
