/*
 * @fileoverview    {CiudadRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code CiudadRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface CiudadRepository extends JpaRepository<Ciudad, Long> {
     ...
     */
    public List<Ciudad> findByIntIdCiudad(Long id);
    ...
    @Query("SELECT m FROM Ciudad m WHERE m.intIdCiudad LIKE CONCAT('%', :strSearch, '%')")
    public List<Ciudad> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Ciudad m WHERE m.intIdCiudad LIKE CONCAT('%', :strSearch, '%')")
    public Page<Ciudad> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
