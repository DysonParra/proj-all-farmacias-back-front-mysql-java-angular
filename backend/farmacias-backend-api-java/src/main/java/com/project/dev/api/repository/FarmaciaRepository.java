/*
 * @fileoverview    {FarmaciaRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code FarmaciaRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface FarmaciaRepository extends JpaRepository<Farmacia, Long> {
     ...
     */
    public List<Farmacia> findByIntCodigoFarmacia(Long id);
    ...
    @Query("SELECT m FROM Farmacia m WHERE m.intCodigoFarmacia LIKE CONCAT('%', :strSearch, '%')")
    public List<Farmacia> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Farmacia m WHERE m.intCodigoFarmacia LIKE CONCAT('%', :strSearch, '%')")
    public Page<Farmacia> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
