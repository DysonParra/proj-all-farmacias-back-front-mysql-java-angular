/*
 * @fileoverview    {LaboratorioMedicamentoServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code LaboratorioMedicamentoServiceImpl}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public class LaboratorioMedicamentoServiceImpl implements LaboratorioMedicamentoService {
    ...
    public LaboratorioMedicamentoDTO saveUpdate(LaboratorioMedicamentoDTO entityDTO) throws Exception {
        ...
        LaboratorioMedicamentoDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
