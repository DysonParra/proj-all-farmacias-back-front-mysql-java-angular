...
/**
 * TODO: Definición de {@code MedicamentoOnlineRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
@org.springframework.stereotype.Repository
public interface MedicamentoOnlineRepository extends JpaRepository<MedicamentoOnline, Long> {
     ...
     */
    public List<MedicamentoOnline> findByIntIdMedicamento(Long id);
    ...
    @Query("SELECT m FROM MedicamentoOnline m WHERE m.intIdMedicamento LIKE CONCAT('%', :strSearch, '%')")
    public List<MedicamentoOnline> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM MedicamentoOnline m WHERE m.intIdMedicamento LIKE CONCAT('%', :strSearch, '%')")
    public Page<MedicamentoOnline> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
