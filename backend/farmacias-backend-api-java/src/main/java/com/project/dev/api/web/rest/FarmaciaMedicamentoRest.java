/*
 * @fileoverview    {FarmaciaMedicamentoRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
import com.project.dev.api.service.implementation.FarmaciaMedicamentoServiceImpl;
import com.project.dev.api.web.rest.assembler.FarmaciaMedicamentoRestAssembler;
...
/**
 * TODO: Definición de {@code FarmaciaMedicamentoRest}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
@Api(value = "FarmaciaMedicamento API")
public class FarmaciaMedicamentoRest {

    private final Logger log = LoggerFactory.getLogger(FarmaciaMedicamentoRest.class);
    private final FarmaciaMedicamentoServiceImpl entityService;
    private final FarmaciaMedicamentoRestAssembler entityRestAssembler;
     ...
     */
    public FarmaciaMedicamentoRest(FarmaciaMedicamentoServiceImpl entityService,
            FarmaciaMedicamentoRestAssembler entityRestAssembler) {
    ...
    public CollectionModel<EntityModel<FarmaciaMedicamentoDTO>> getAllEntities() {
        ...
        try {
            ...
            CollectionModel<EntityModel<FarmaciaMedicamentoDTO>> entitiesCollection = new CollectionModel<>(entities);
            entitiesCollection.add(linkTo(methodOn(FarmaciaMedicamentoRest.class).getAllEntities()).withSelfRel());
    ...
    public ResponseEntity<List<FarmaciaMedicamentoDTO>> getAllEntitiesPaged(Pageable pageable) {
