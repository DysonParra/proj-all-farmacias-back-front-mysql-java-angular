...
public class CiudadRest {
    ...
    public ResponseEntity<List<CiudadDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    public ResponseEntity<List<CiudadDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
