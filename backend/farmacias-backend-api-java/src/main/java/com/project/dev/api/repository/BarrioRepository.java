...
/**
 * TODO: Definición de {@code BarrioRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface BarrioRepository extends JpaRepository<Barrio, Long> {
     ...
     */
    public List<Barrio> findByIntIdBarrio(Long id);
    ...
    @Query("SELECT m FROM Barrio m WHERE m.intIdBarrio LIKE CONCAT('%', :strSearch, '%')")
    public List<Barrio> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Barrio m WHERE m.intIdBarrio LIKE CONCAT('%', :strSearch, '%')")
    public Page<Barrio> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
