/*
 * @fileoverview    {LaboratorioMedicamentoMapping} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
public interface LaboratorioMedicamentoMapping extends GenericMapping<LaboratorioMedicamentoDTO, LaboratorioMedicamento> {
    ...
    @Mapping(source = "intId", target = "intId")
    @Override
    public LaboratorioMedicamentoDTO obtenerDto(LaboratorioMedicamento entity);
